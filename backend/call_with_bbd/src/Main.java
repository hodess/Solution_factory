...
public class Main {
    public static void main(String[] args) {
        ...
        // Créer des gares
        Gare gare1 = new Gare("Gare du Nord_4", line4, 48, 88);
        Gare gare1_2 = new Gare("Gare du Nord_5", line5, 48, 88);
        Gare gare2 = new Gare("Gare de Lyon", line4, 50, 84);
        Gare gare3 = new Gare("Gare de l'est", line5, 48, 88);
        Gare gare4 = new Gare("Gare Montparnasse", line5, 50, 84);
        Gare gare7 = new Gare("Chatelet", line5, 50, 84);

        // Créer des voies
        new Voie(gare1_2,gare1, line0, 60,0);
